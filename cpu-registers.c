...
uint16_t cpu_reg_pair_get(const cpu_t* cpu, reg_pair_kind reg){
    ...
    switch(reg){
        ...
        case REG_HL_CODE : return cpu -> HL; break;
        case REG_AF_CODE : return cpu -> AF; break;
        default : return 0;
...
uint8_t cpu_reg_get(const cpu_t* cpu, reg_kind reg){
    ...
    switch(reg){
        ...
        case REG_D_CODE : return cpu -> D; break;
        case REG_E_CODE : return cpu -> E; break;
        case REG_H_CODE : return cpu -> H; break;
        case REG_L_CODE : return cpu -> L; break;
        case REG_A_CODE : return cpu -> A; break;
        default : return 0;
    }
}
